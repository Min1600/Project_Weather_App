...
loading.style.display = "block"
    ...
    async function displayTodayData(){
        ...
        temp.textContent = "Temperature: " + Math.round((weatherData.currentConditions.temp -32)*5/9) + "°C"
    ...
    async function displayData(x){
        ...
        time.textContent = ""
        temp.textContent = "Temperature: " + Math.round((weatherData.days[x].temp -32)*5/9) + "°C"
